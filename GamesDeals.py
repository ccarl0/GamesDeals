...
def get_games_news(i):
    ...
    # Getting game link
    game_link = json[i - 1]['open_giveaway_url']
...
# Page Buttons
previous_page_button_side = tk.Button(frame, text="Previous Page", command=lambda: previous_page(), heigh=12, width=11,
                                      font=("Arial", 12), bg="#ffb3ff", activebackground="#660066")
previous_page_button_side.pack(side=tk.LEFT)

next_page_button_side = tk.Button(frame, text="Next Page", command=lambda: next_page(), heigh=12, width=11,
                                  font=("Arial", 12), bg="#ffb3ff", activebackground="#4d004d")
